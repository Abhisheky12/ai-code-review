  ...
  return (
    ...
    <div className="min-h-screen w-full lg:grid lg:grid-cols-2 bg-zinc-950 text-foreground font-sans antialiased select-none relative">
      ...
      <div className="hidden lg:flex flex-col justify-between p-16 bg-gradient-to-br from-zinc-900/60 via-zinc-950/80 to-zinc-900/60 border-r border-border/40 relative z-10 backdrop-blur-xl">
        ...
        {/* Hero Content */}
        <div className="space-y-8 my-auto max-w-xl xl:max-w-2xl">
          <h1 className="text-6xl xl:text-6xl font-extrabold tracking-tight leading-[1.05] bg-gradient-to-b from-white via-zinc-200 to-zinc-400 bg-clip-text text-transparent">
            Ship Better Code. <br />
            Review Pull Requests <br />
            With AI.
          </h1>

          <p className="text-muted-foreground text-lg xl:text-xl leading-relaxed font-normal max-w-xl">
            Connect your repositories, analyze pull requests instantly,
            and receive context-aware code reviews powered by AI before
        ...
        <div className="grid grid-cols-2 gap-6 border-t border-border/30 pt-8 max-w-md">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Automated feedback on every code change.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Context-aware analysis powered by AI.
            </p>
          </div>
        </div>
      </div>
